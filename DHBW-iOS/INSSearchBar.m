...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), CGRectGetWidth(frame), 34.0)]))
	{
        ...
        self.searchField.textColor = [UIColor colorWithRed:0.941 green:0.241 blue:0.241 alpha:1.000];
		...
		self.searchImageViewOn.image = [UIImage imageNamed:@"NavBarIconSearch_red"];
		...
		self.searchImageCircle.image = [UIImage imageNamed:@"NavBarIconSearchCircle_red"];
		...
		self.searchImageCrossLeft.image = [UIImage imageNamed:@"NavBarIconSearchBar_red"];
		...
		self.searchImageCrossRight.image = [UIImage imageNamed:@"NavBarIconSearchBar2_red"];
