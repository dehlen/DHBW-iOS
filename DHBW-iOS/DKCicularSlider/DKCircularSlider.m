    ...
    if(self){
        ...
        switch (represantationMode) {
            ...
            case DKCircularSliderRepresantationModeValues:
                ...
                _textField.textColor = [UIColor colorWithWhite:0.687 alpha:.66];
                [self prepareSingleButtons];
                break;
            default:
                _textField = [self prepareTextFieldUsingFrame:frame
...
-(void)drawRect:(CGRect)rect{
    ...
    CGContextAddArc(ctx,
                    ...
                    M_PI *2,
                    0);
    [[UIColor colorWithWhite:0.687 alpha:0.660]setStroke];
    ...
    CGFloat components[8] = {
        1.0, 0.968627451, 0.745098039, 1.0,
        1.0, 0.184313725, .388235294, 1.0 };
...
- (void)drawGuide:(CGPoint)point onContext:(CGContextRef) context
{
    ...
    if (values!=nil) {
        ...
        for (int x=1; x<=values.count; x++) {
            ...
            [[UIColor colorWithWhite:0.687 alpha:0.000]set];
